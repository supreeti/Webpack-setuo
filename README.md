...
This project is about webpack configuration for practise.
...
```sh
  cd my-folder
  git clone https://github.com/supreeti/Webpack-Setup.git
```
### Install
...
Feel free to check the [issues page](https://github.com/supreeti/Webpack-Setup/issues/new).
...
This project is [MIT](https://github.com/supreeti/Webpack-Setup/blob/main/LICENSE) licensed.
<p align="right">(<a href="#readme-top">back to top</a>)</p>
